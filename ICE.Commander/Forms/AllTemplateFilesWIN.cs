...
{
    public class AllTemplateFilesWIN : BaseTestFormWIN
    {
        public AllTemplateFilesWIN() : base()
        {
            Text = "All Template Files in Public Folders";
        }
        ...
        protected override void GoGetThem_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(LoanNumber.Text))
            {
                ...
                {
                    var temps = Task.Run(() => _api.GetLoanTemplatesAsync(guid)).Result;
