...
{
    public class AllNextMilestonesWIN : BaseTestFormWIN
    {
        public AllNextMilestonesWIN() : base()
        {
            Text = "All Mext Milestones";
        }
        protected override void GoGetThem_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(LoanNumber.Text))  // "0550469290"
            {
                ...
                {
                    var ms = Task.Run(() => _api.NextMilestoneAsync(guid)).Result;
